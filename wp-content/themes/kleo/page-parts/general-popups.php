  ...
  <div class="row">
    <div class="col-sm-12 text-center">
      <div class="kleo-pop-title-wrap alternate-color">
        <h2 class="kleo-pop-title"><?php _e( "Log in", "kleo_framework" ); ?></h2>
    
        <?php if(get_option('users_can_register')) : ?>

          <a href="<?php if (function_exists('bp_is_active')) bp_signup_page(); else echo get_bloginfo('url')."/wp-login.php?action=register"; ?>" class="new-account"><?php _e( "Create an account", "kleo_framework" ); ?></a>
  ...
  <div class="row">
    <div class="col-sm-12 text-center">
      ...
      <form id="forgot_form" name="forgot_form" action="" method="post" class="kleo-form-signin">
        <?php wp_nonce_field( 'kleo-ajax-login-nonce', 'security' ); ?>
        <input type="text" id="forgot-email" autofocus required  name="email" class="form-control" placeholder="<?php _e("Username or Email",'kleo_framework');?>">
