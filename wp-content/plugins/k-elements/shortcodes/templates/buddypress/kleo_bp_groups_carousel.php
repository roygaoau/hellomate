...
if ( function_exists('bp_is_active') && bp_is_active('groups') ) {
	...
	if ( bp_has_groups( $params ) ){
			...
			$output .='<div class="kleo-carousel-items kleo-groups-carousel" data-min-items="'.$min_items.'" data-max-items="'.$max_items.'">';
					...
					$output .='<div class="loop-image">';
						...
						$output .='<div class="item-avatar '.$rounded.'">';
							$output .= '<a href="'. bp_get_group_permalink() .'" title="'. esc_attr( bp_get_group_name()) .'">';
								$output .= bp_get_group_avatar( array(	'type' => 'full', 'width' => $item_width, 'height' => $item_width ));
